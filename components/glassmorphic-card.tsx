...
export function GlassmorphicCard({ children }: GlassmorphicCardProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
    >
      <div className="relative overflow-hidden rounded-xl bg-zinc-800/75 border border-zinc-700/50 p-6 transition-all duration-300 hover:border-phthalo-500/50">
