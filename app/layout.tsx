...
export const metadata: Metadata = {
  ...
  description:
    'Portfolio of Andhika August Farnaz - Web Developer, Data Scientist, and ML Engineer specializing in algorithmic trading, predictive modeling, and intelligent automation.',
  icons: {
    icon: '/favicon.ico',
  },
}
